...
##erDiagram
  ...
  SUBJECTS ||--o{ CLASS_MEETINGS : "scheduled as"
  SUBJECTS ||--o{ ASSESSMENTS : "has"
  SUBJECTS ||--o{ STUDY_SESSIONS : "studied in"

  STUDY_SESSIONS ||--o{ SESSION_FEEDBACK : "receives"
  STUDY_SESSIONS ||--o{ CALENDAR_EVENTS : "synced as"
  NOTIFICATIONS }o--|| STUDY_SESSIONS : "optional about"
