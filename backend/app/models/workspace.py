...
class Workspace(Base):
    ...
    parent = relationship(
        "Workspace",
        remote_side=[id],
        back_populates="subworkspaces",
        passive_deletes=True,
    )

    subworkspaces = relationship(
        "Workspace",
    ...
    member_delete_logs = relationship(
        "MemberDeleteLog",
        back_populates="workspace",
        cascade="all, delete-orphan",
        passive_deletes=True,
...
class MemberDeleteLog(Base):
    ...
    workspace = relationship("Workspace", back_populates="member_delete_logs")
