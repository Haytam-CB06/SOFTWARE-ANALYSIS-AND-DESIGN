import { BookOpen, Calendar, CheckCircle2, Clock, HelpCircle, Lightbulb, MousePointer, Plus, Save, Settings, Zap, Sparkles } from 'lucide-react';
    ...
    <Dialog>
      ...
      <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-6 py-4">
          {/* Walkthrough / Onboarding Tour (re-runnable) */}
