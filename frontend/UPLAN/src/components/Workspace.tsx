...
export default function Workspace({ onNavigate }: WorkspaceProps) {
  ...
  const loadWorkspaces = async () => {
    ...
    try {
      ...
      const msg = e instanceof ApiError ? e.message : (e?.message || 'Failed to load workspaces');
      toast.error(msg);
    }
  };
...
const handleCreateSubworkspace = async () => {
  ...
  const handleCreateWorkspace = async () => {
    ...
    try {
      ...
      const msg = e instanceof ApiError ? e.message : (e?.message || 'Failed to create workspace');
      toast.error(msg);
    }
  };
