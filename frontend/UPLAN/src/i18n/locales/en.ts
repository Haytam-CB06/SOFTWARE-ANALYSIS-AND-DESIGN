const en = {
  ...
  autoGenerate: {
  title: "Auto Generate Study Timetable",
  subtitle: "Configure your schedule and generate optimized study sessions.",
  studyWindow: {
    title: "Study Window",
    description: "Set when you're available to study and adjust it anytime.",
    weekdayStart: "Weekday start",
    weekdayEnd: "Weekday end",
    breakMinutes: "Break between study sessions (minutes)",
    breakHelp: "We’ll leave this gap between consecutive generated sessions so you can rest and reset.",
    includeWeekends: "Include weekends",
    includeWeekendsHelp: "If enabled, we also fill free time on Saturday and Sunday.",
    sameWeekend: "Use same weekend window",
    sameWeekendHelp: "Weekend hours equal weekday hours.",
    weekendStart: "Weekend start",
    weekendEnd: "Weekend end"
  },
  classSchedule: {
    title: "Class Schedule & Priority",
    description: "Add your current timetable and set the priority of each course. The generator uses this with busy time to find your free study slots.",
    fillButton: "Fill Current Timetable",
    uploadButton: "Upload",
    emptyTitle: "No class timetable saved yet",
    emptyDescription: "Use Fill Current Timetable or Upload to add your courses.",
    addAnotherSlot: "Add another time slot for this course",
    ...
    addCourseRowHelp: "The same course can appear multiple times with different days or times."
  },
  busyTime: {
    title: "Busy Time",
    description: "Add extra busy blocks like work, commuting, or errands. Auto-generate will never place study sessions there.",
    treatExisting: "Treat existing calendar sessions as busy",
    treatExistingHelp: "Uses your current week sessions as additional busy time ({{count}} session(s) found).",
    replaceExisting: "Replace existing study sessions",
    replaceExistingHelp: "If enabled, we remove previously generated study sessions before adding new ones.",
    addBusy: "Add busy block",
    titleLabel: "Title",
    day: "Day",
    start: "Start",
    end: "End"
  ...
  upload: {
    ...
    description: "Upload a CSV or image of your timetable. After import, set priorities and click Save.",
    selectFile: "Choose file to upload",
    buttonHint: "Supports image or CSV"
  },
  priority: {
    high: "HIGH",
    medium: "MEDIUM",
  ...
  busyDefaultTitle: "Busy time",
  generate: "Generate",
  generating: "Generating…",
  success: {
    busySavedWorkspace: "Busy time saved to workspace",
    classSavedWorkspace: "Class timetable saved to workspace",
    classSaved: "Class timetable saved",
    importedRows: "Imported {{count}} timetable row(s). Now set priorities and click Save.",
    generatedSessions: "Generated {{count}} study sessions{{seed}}."
  },
  errors: {
    saveBusy: "Failed to save busy time",
    addCourseFirst: "Add at least one course in your class timetable",
    saveClass: "Failed to save class timetable",
    uploadCsvOrImage: "Upload a CSV or image file",
    uploadFailed: "Upload failed",
    uploadFailedGeneric: "Upload failed",
    noClassesDetected: "No classes detected from the uploaded file",
    invalidImportFormat: "Imported file did not match the expected timetable format",
    courseNameRequired: "Course name is required",
    selectAtLeastOneDay: "Select at least one day",
    missingApiBase: "Missing VITE_API_BASE_URL. Configure your frontend env.",
    notLoggedIn: "You are not logged in",
    fillOrUploadFirst: "Fill or upload your class timetable first",
    generateFailed: "Auto generation failed",
    noFreeTime: "No free time available for the selected study window"
  }
  },
  auth: {
  brand: {
  ...
  hero: {
    ...
    description:
      "AI-powered timetable planning that adapts to your classes, exams, deadlines, and goals in one clean workspace.",
  ...
  help: {
    ...
    issuesDescription:
      "If you’re having trouble signing up or logging in, please check your internet connection and make sure all required fields are completed correctly.",
    points: {
  ...
  errors: {
    ...
    sendSignupCodeFailed: "email or username already registred, try other ones",
...
errorBoundary: {
  ...
  description: 'The app crashed while rendering this page. Refresh to recover.',
  actions: {
    reload: 'Reload',
...
examTracker: {
  title: 'Exam Tracker',
  subtitle: 'Track your upcoming exams and prepare accordingly',
  ...
  dialog: {
    title: 'Add New Exam',
    description: 'Schedule a new exam or test session for your study timetable.',
  },
  ...
  empty: {
    ...
    subtitle: 'Add your exam dates to start tracking',
  },
  ...
  errors: {
    required: 'Please fill in subject and date',
  },
},
goals: {
  title: 'Goals & achievements',
  subtitle: 'Track weekly targets, study consistency, and upcoming milestones.',
...
googleCalendar: {
  ...
  confirm: {
    disconnect:
      'Are you sure you want to disconnect from Google Calendar? Your existing calendar events will not be affected.',
  },
},
help: {
  button: 'Help',
...
privacyPolicy: {
  ...
  sections: {
    ...
    storage: {
      ...
      description:
        'Local Storage: All your data is stored locally in your browser using localStorage technology. This means:',
      items: [
...
pomodoro: {
  ...
  unpinWidgetHint: 'Unpin widget (will close on navigation)',
  pinWidgetHint: 'Pin widget (stays open on navigation)',
  ...
  settings: {
    ...
    break: 'Break',
    longBreak: 'Long Break',
    durationsMinutes: 'Durations (minutes)',
    ...
    longBreakAfterEvery: 'Long break after every',
...
settings: {
  ...
  about: {
    ...
    description:
      'Our platform helps learners and study teams plan schedules, manage deadlines, track progress, and stay aligned with structured study workflows.',
  },
...
courseEdit: {
  ...
  confirmDelete:
    'Are you sure you want to delete "{{name}}"? This will regenerate your timetable without this course.',
},
...
sharedTimetable: {
  ...
  selectedEditorsInfo:
    'Selected: {{count}} member(s). You (owner) can always edit.',
...
timetable: {
  ...
  summary: {
    ...
    description:
      'Your schedule was generated using course priority, preferred study windows, blocked time, and session/break settings.',
    priorityLabel: 'Priority-based allocation:',
    priorityText:
      'higher-priority courses are placed in stronger study windows.',
    timePreferencesLabel: 'Time preferences:',
    timePreferencesText:
      'courses are placed in preferred morning, afternoon, or evening windows where possible.',
    conflictAvoidanceLabel: 'Conflict avoidance:',
    conflictAvoidanceText:
      'study sessions avoid {{count}} blocked slot(s).',
    sessionStructureLabel: 'Session structure:',
    sessionStructureText:
      '{{sessionDuration}} minute sessions with {{breakDuration}} minute breaks.',
  },
  ...
  unavailableTime: {
    ...
    description:
      'Study sessions were scheduled around {{count}} unavailable time slot(s).',
  },
  ...
  empty: {
    ...
    description:
      'There was an issue generating the schedule. Please check that you selected study days and added courses.',
  },
  ...
  tips: {
    ...
    followScheduleText:
      'the timetable was generated around your priorities and free time.',
    useBreaksLabel: 'Use breaks well:',
    useBreaksText:
      'rest, hydrate, and reset between study blocks.',
    adjustWhenNeededLabel: 'Adjust when needed:',
    adjustWhenNeededText:
      'regenerate if your courses or unavailable time change.',
    stayConsistentLabel: 'Stay consistent:',
    stayConsistentText:
      'shorter repeatable sessions usually work better than overloading one day.',
  },
  ...
  toast: {
    splitSuccess:
      'Long sessions split into Pomodoros! Sessions over 90 minutes have been divided with breaks.',
    mergeSuccess:
      'Adjacent sessions merged! Same-subject sessions close together have been combined.',
    savedWithWeek: 'Timetable saved! Sessions added to week {{weekId}}',
    addedToMyTimetable:
      '{{count}} sessions added to My Timetable for week {{weekId}}!',
    pdfComingSoon: 'PDF export feature coming soon!',
    googleCalendarConnectFirst:
      'Please connect to Google Calendar in Settings first',
    exportingGoogleCalendar: 'Exporting to Google Calendar...',
    exportedGoogleCalendar:
      'Successfully exported {{count}} study sessions to Google Calendar!',
    ...
    cannotDeleteLastCourse:
      'Cannot delete the last course. Please add another course first.',
...
terms: {
  ...
  dashboard: {
  refresh: 'Refresh',
  tasksDone: 'Assessments completed on time',
  tasks: 'tasks',
  ...
  noMoreSessionsToday: "No more sessions today",
  todaysScheduleProgress: "Today’s schedule & progress",
  totalHours: "Total hours",
  completed: "Completed",
  minutesShort: "min",
  noSessionsToday: "No sessions scheduled for today",
  addSessions: "Add sessions",
  studyProgressOverview: "Study progress overview",
  week: "Week",
  month: "Month",
  completedHours: "Completed hours",
  weeklyGoal: "Weekly goal",
  setWeeklyGoalHint: "Set a weekly goal in Goals & Achievements",
  noStudyDataWeek: "No study data for this week. Start scheduling sessions to track your progress.",
  deadlines: "Deadlines",
  priority: {
    high: "High",
    medium: "Medium",
  ...
  viewAll: "View all",
  untitledTimetable: "Untitled timetable",
  active: "Active",
  activate: "Activate",
  noSavedTimetables: "No saved timetables yet",
  ...
  workspace: {
    ...
    chat: {
      welcome: "Welcome to {{name}}! Start collaborating with your team.",
      ...
      newMessagesCount_one: "{{count}} new message",
      ...
      success: {
        ...
        fileShared: "File shared in chat!"
      },
      errors: {
    ...
    confirm: {
      ...
      disableShareLink:
        "Are you sure you want to disable the sharing link? No one will be able to use it to join.",
    },
  ...
  homepage: {
    hero: {
      ...
      description1:
        "U PLAN automatically builds your study timetable around exams, classes, deadlines, and your real free time.",
      description2:
        "No more guessing when to study. No more overloaded days. Just a flexible, personalized plan that actually works.",
    ...
    about: {
      ...
      missionParagraph1:
        "We created U PLAN to make studying more organized, flexible, and realistic. Students already have enough pressure — your planning tool should reduce stress, not add to it.",
      missionParagraph2:
        "By combining smart automation with student-first design, U PLAN helps you fit studying around exams, classes, deadlines, and life outside school.",
    ...
    whyChoose: {
      ...
      paragraph1:
        "U PLAN was built for the reality of student life: shifting deadlines, changing schedules, multiple subjects, and limited energy. Traditional planners don't adapt. We do.",
      paragraph2:
        "Whether you're preparing for finals, balancing multiple courses, or trying to stay consistent without burning out, U PLAN helps you study with more structure and less guesswork.",
    },
    ...
    services: {
      smartTimetableGeneration: {
        ...
        description:
          "Automatically create a personalized study plan based on your input (exam dates, free hours, goals, etc.). Our intelligent algorithm considers your schedule, priorities, and learning patterns to generate an optimal timetable.",
        features: {
      ...
      adaptiveUpdates: {
        ...
        description:
          "If you skip or complete sessions, the system adjusts your timetable automatically. Life happens — our platform understands that and makes real-time adjustments to keep you on track.",
        features: {
      ...
      progressTracking: {
        title: "Progress Tracking",
        description:
          "Track your daily and weekly study progress to stay motivated. Visualize your achievements, identify patterns, and celebrate milestones as you work towards your goals.",
        features: {
      ...
      examClassIntegration: {
        ...
        description:
          "Import your exam schedule and class timetable for a conflict-free plan. Seamlessly integrate your academic calendar to ensure optimal study time distribution.",
        features: {
    ...
    collaborationSection: {
      ...
      subtitle:
        "Create study groups, manage team members, and collaborate seamlessly in shared workspaces",
    },
    ...
    collaborationFeatures: {
      teamCollaborationWorkspaces: {
        ...
        description:
          "Create dedicated workspaces for study groups, project teams, or classes. Organize members with role-based access control (Admin/Member) and manage permissions effortlessly.",
      },
      smartMemberSharing: {
        title: "Smart Member Sharing",
        description:
          "Generate secure shareable links to invite team members. Control access with open or domain-restricted settings. Pending requests feature ensures controlled workspace growth.",
      },
      integratedTeamChat: {
        title: "Integrated Team Chat",
        description:
          "Communicate with team members directly within workspaces. Real-time messaging keeps discussions organized and contextual to your collaborative planning.",
      },
      hierarchicalSubworkspaces: {
        title: "Hierarchical Subworkspaces",
        description:
          "Organize complex team structures with subworkspaces. Create parent-child workspace hierarchies for departments, projects, or study groups with inherited member permissions.",
      },
      teamProgressDashboard: {
        title: "Team Progress Dashboard",
        description:
          "Monitor individual and collective progress. Track session completion rates, upcoming deadlines, and team productivity metrics in real-time.",
      },
      workspaceCustomization: {
        title: "Workspace Customization",
        description:
          "Upload workspace avatars, set permissions, manage sharing settings, and configure timetable editing rights. Full control over your collaborative environment.",
      },
    },
    ...
    finalCta: {
      ...
      description:
        "Join successful students from top universities who've improved their grades, balanced their workload, and achieved their academic goals with U PLAN.",
